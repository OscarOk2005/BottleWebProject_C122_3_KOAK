...
<div class="container">
        ...
        <form class="mb-3" action="/daykstra_result" method="GET" action="/action_page.php" onsubmit="return validateForm()" required name="daykstra_calculations" id="matrix_form">
            ...
            <button type="button" class="btn btn-primary" onclick="createMatrix()">Создать матрицу</button>
             <button value="send" type="submit" class="btn btn-primary" >Подсчитать</button>
        </form>
